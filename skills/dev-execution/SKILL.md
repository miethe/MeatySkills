...
| [Milestone Checks](./validation/milestone-checks.md) | Phase completion criteria (includes Route 7 findings triage) |
| [Completion Criteria](./validation/completion-criteria.md) | Story/feature done definition |
| [Phase Execution — Findings](./modes/phase-execution.md) | Agent findings frontmatter stub + promotion pipeline |
