CGH/1 — cgh-20260917-inspect-a-synthetic-workflow-diagram — revision 1 — current turn T01
...
Frozen manifest SHA-256: 63008b19afc7279cce0c03547d98552181e850d96430cbf89ae0bcbb12e4dc26.
...
## Outcome
Find differences between the actual attached diagram and the expected labels Request → Approval → Action.
...
```json
{
  "review_target": "Actual attached synthetic QA fixture; not a screenshot of a real application.",
  "criteria": [
    "Expected labels are Request, Approval, Action.",
    "Three nodes connected left to right with arrowheads.",
    "Report exact region and severity for any spelling defect."
  ],
  "severity_scheme": "critical / major / minor",
  "allowed_changes": "Review only; no edits",
  "output_structure": [
    "Issues by view and region",
...
```json
{
  ...
  "pack_id": "cgh-20260917-inspect-a-synthetic-workflow-diagram",
  "manifest_sha256": "63008b19afc7279cce0c03547d98552181e850d96430cbf89ae0bcbb12e4dc26",
  "status": "partial",
  "completed_turn_ids": [],
  "files": [],
  "findings": [],
