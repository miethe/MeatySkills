CGH/1 — cgh-20260917-bounded-handoff-architecture-decision — revision 1 — current turn T01
...
Frozen manifest SHA-256: aa4f805cf866ce38aaa4dd9c38322c2addf9274bc436ff223dc7da90d1b0b1ae.
...
## Outcome
Choose between one large consultation and staged research/review turns for a difficult architecture decision.
...
Capability: pro_reasoning. Route: pro-decision.
Preferred UI selection: GPT-6 Pro; thinking: Pro selection; no separate effort asserted.
This is a preference, not a claim that the UI has been selected or can be changed by this prompt.
Required capability: task-dependent; verify in Chat. Missing-capability handling: ask_before_downgrade.
...
```json
{
  "decision": "How should a human-relayed Chat consultation be split to preserve evidence and minimize rework?",
  "alternatives": [
    "One combined request",
    "Research first, decision second",
    "Several independent research runs, then synthesis"
  ],
  "evidence_policy": "Use the supplied scenario as assumptions, not empirical performance evidence.",
  "adversarial_questions": [
    "Where would splitting lose context?",
    "Which decisions could be made locally?",
    "What makes a separate Pro review worth its allowance?"
  ],
  "output_structure": [
...
```json
{
  ...
  "pack_id": "cgh-20260917-bounded-handoff-architecture-decision",
  "manifest_sha256": "aa4f805cf866ce38aaa4dd9c38322c2addf9274bc436ff223dc7da90d1b0b1ae",
  "status": "partial",
  "completed_turn_ids": [],
  "files": [],
  "findings": [],
