...
""",
    ...
    parser.add_argument(
        ...
        "-t",
        default="all",
        help="Type filter: prd|implementation|spike|quick-feature|phase-plan|design-spec|meta-plan|report|all",
    )
    ...
    if normalized_type is None:
        print(
            "Error: Invalid --type. Use prd, implementation, spike, quick-feature, phase-plan, design-spec, meta-plan, report, or all.",
            file=sys.stderr,
        )
        sys.exit(1)
