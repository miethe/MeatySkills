...
|------|------|---------|------|-------|
| **envelope.schema.yaml** _(skill_spec)_ | Skill Spec | Base envelope validation for `doc_type: skill_spec` (SPEC.md files). Authoritative field spec: `.claude/specs/skill-spec-convention.md` | — | — |
