...
Pass the haiku summary (file path or inline block) to the contract writer subagent — do not re-read the issue yourself. Output location: `docs/project_plans/feature_contracts/[slug].md`
