...
`docs/project_plans/PRDs/features/dynamic-artifact-provisioning.md` §6.1.
...
Everything above is driven from `docs/project_plans/PRDs/features/dynamic-artifact-provisioning.md`
...
- **PRD**: `docs/project_plans/PRDs/features/dynamic-artifact-provisioning.md`
